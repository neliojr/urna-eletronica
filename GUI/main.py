...
class Application:
    ...
    def menu(self):
        ...
        role_menu.add_command(
            label="Novo",
            command=self.open_create_role_window
        )
        role_menu.add_command(
            label="Remover",
            command=self.open_remove_role_window
        )
        role_menu.add_command(
            label="Buscar",
            command=self.open_find_role_window
        )
        role_menu.add_command(
            label="Listar"
        )
        ...
        config_menu.add_command(
            label="Alterar número de dígitos do eleitor"
        )
        config_menu.add_command(
            label="Alterar senha do administrador"
        )
        config_menu.add_command(
            label="Mudar para TUI",
